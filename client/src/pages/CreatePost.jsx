           ...
           <div className='flex flex-col gap-5'>
                <FormField
                 ...
                 <FormField
                    ...
                    type="text"
                    name="prompt"
                    placeholder="A cat sitting on a bed"
                    value={form.prompt}
                    handleChange={handleChange}
                    isSurpriseMe
                    handleSurpriseMe={handleSurpriseMe}
                 />
                 <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text.sm rounded-lg focus:ring-offset-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center '>
                  {form.photo ? (
